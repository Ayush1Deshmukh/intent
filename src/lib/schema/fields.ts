...
export const CANONICAL_FIELDS = [
  "loanId", "borrowerId", "loanType", "originationDate", "maturityDate",
  "originalPrincipal", "currentBalance", "interestRate", "termMonths",
  "paymentAmount", "paymentStatus", "daysPastDue", "borrowerState",
  "borrowerZip", "creditScore", "appraisedValue", "servicerId",
  "lastUpdatedAt", "documentStatus",
] as const;
...
export const ALIASES: Record<CanonicalField, string[]> = {
  ...
  servicerId:        ["servicer","servicer id","sub servicer","subservicer","svcr","servicer code","seller servicer"],
