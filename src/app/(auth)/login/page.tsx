...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-[1fr_460px]">
      <section className="hidden lg:flex flex-col justify-between p-12 bg-surface border-r border-line">
        <div className="flex flex-col gap-6 max-w-lg">
          ...
          <div className="flex flex-col gap-3 text-sm text-ink2 border-l-2 border-brass pl-4">
        ...
        <p className="text-xs text-muted mono">three roles · 28 rules · append-only audit chain</p>
      </section>
